...
import ActivityBar from '@/features/workspace/components/ActivityBar.svelte';
import FileTree from '@/features/workspace/components/FileTree.svelte';
import Sidebar from '@/features/workspace/components/Sidebar.svelte';
import SidebarContextMenu from '@/features/workspace/components/SidebarContextMenu.svelte';
import { sidebarActions, sidebarState } from '@/features/workspace/workspaceStore';
import type { FileNode } from '@/features/workspace/workspaceService';
import TabBar from '@/features/documents/tabs/TabBar.svelte';
import TabItem from '@/features/documents/tabs/TabItem.svelte';
import { tabsState, type EditorTab } from '@/features/documents/tabs/tabStore';
